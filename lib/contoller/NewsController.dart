...
import 'package:flutter_getx/model/ArticalModel.dart';
import 'package:flutter_getx/model/NewsModel.dart';
...
class NewsController extends GetxController {
  ...
  getNews({channel = '', searchKey = '', reload = false}) async {
    ...
    baseApi += 'apiKey=f9a1445c523b4aa88f383f6dc0fc408e';
    if (channel != '') {
      country.value = '';
      category.value = '';
      baseApi =
          "https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&sources=$channel&apiKey=f9a1445c523b4aa88f383f6dc0fc408e";
    }
    if (searchKey != '') {
      country.value = '';
      category.value = '';
      baseApi =
          "https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&q=$searchKey&apiKey=f9a1445c523b4aa88f383f6dc0fc408e";
    }
    print(baseApi);
