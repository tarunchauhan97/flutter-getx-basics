...
import 'package:flutter_getx/contoller/NewsController.dart';
import 'package:flutter_getx/view/ViewNews.dart';
import 'package:flutter_getx/view/components/sideDrawer.dart';
                            ...
                            Padding(
                              ...
                              child: Card(
                                ...
                                child: GestureDetector(
                                  onTap: () =>
                                      Get.to(ViewNews(newsUrl: controller.news[index].url)),
                                  child: Container(
                                          ...
                                          Positioned(
                                            ...
                                            child: Card(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Text("${controller.news[index].source.name}",
